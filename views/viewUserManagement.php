                    ...
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-info">
                            ...
                            <ul class="post-footer">
                                <?php if ($user['role'] == 0) { ?>
                                    <li><a href="admin&modifyUser&id=<?= $user['id'] ?>"onclick="return confirm('Voulez-vous ajoutés cette utilisateur Administrateur du site')" title="Passer en Admin"><i class="ion-android-person-add"></i></a></li>
                                <?php } ?>
