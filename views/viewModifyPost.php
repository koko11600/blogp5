                    ...
                    <form method="post" action="admin&editPost=action" class="contact1-form validate-form">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" aria-required="true" minlength="3" name="title" value="<?= $post['title'] ?>" class="form-control" aria-invalid="true" required>
                            </div>
                            <div class="col-sm-12">
                                <input type="text" aria-required="true" minlength="3" name="chapo" value="<?= $post['chapo'] ?>" class="form-control" aria-invalid="true" required>
                            ...
                            <div class="col-sm-12">
                                <textarea aria-required="true" rows="4" name="content" class="form-control" aria-invalid="true" required><?= $post['content'] ?></textarea>
                            </div>
